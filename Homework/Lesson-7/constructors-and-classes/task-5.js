...
const clients = [
    ...
    new Client(5, 'name5', 'surname5', '123@123.com', '123123123', [new Product('tv', 10000), new Product('phone', 123123)]),
    ...
    new Client(8, 'name8', 'surname8', '123@123.com', '123123123', [new Product('tv', 10000),  new Product('phone', 123123),  new Product('phone', 123123)]),
